...
nonlinear_age <- read.csv("./revision-03-csd-crc/results/nonlinear_age.csv")
nonlinear_pln <- read.csv("./revision-03-csd-crc/results/nonlinear_pln.csv")
nonlinear_race_white <- read.csv("./revision-03-csd-crc/results/nonlinear_race_white.csv")
nonlinear_race_black <- read.csv("./revision-03-csd-crc/results/nonlinear_race_black.csv")
nonlinear_race_others <- read.csv("./revision-03-csd-crc/results/nonlinear_race_others.csv")

nonlinear_site_right_colon <- read.csv("./revision-03-csd-crc/results/nonlinear_site_right_colon.csv")
nonlinear_site_left_colon <- read.csv("./revision-03-csd-crc/results/nonlinear_site_left_colon.csv")
nonlinear_site_rectum <- read.csv("./revision-03-csd-crc/results/nonlinear_site_rectum.csv")

nonlinear_hist_adeno <- read.csv("./revision-03-csd-crc/results/nonlinear_hist_adeno.csv")
nonlinear_hist_others <- read.csv("./revision-03-csd-crc/results/nonlinear_hist_others.csv")

nonlinear_grade_1 <- read.csv("./revision-03-csd-crc/results/nonlinear_grade_1.csv")
nonlinear_grade_2 <- read.csv("./revision-03-csd-crc/results/nonlinear_grade_2.csv")
nonlinear_grade_3 <- read.csv("./revision-03-csd-crc/results/nonlinear_grade_3.csv")
nonlinear_grade_4 <- read.csv("./revision-03-csd-crc/results/nonlinear_grade_4.csv")


nonlinear_Tstage_T1 <- read.csv("./revision-03-csd-crc/results/nonlinear_Tstage_T1.csv")
nonlinear_Tstage_T2 <- read.csv("./revision-03-csd-crc/results/nonlinear_Tstage_T2.csv")
nonlinear_Tstage_T3 <- read.csv("./revision-03-csd-crc/results/nonlinear_Tstage_T3.csv")
nonlinear_Tstage_T4a <- read.csv("./revision-03-csd-crc/results/nonlinear_Tstage_T4a.csv")
nonlinear_Tstage_T4b <- read.csv("./revision-03-csd-crc/results/nonlinear_Tstage_T4b.csv")


nonlinear_AJCC7N_1 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7N_1.csv")
nonlinear_AJCC7N_2 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7N_2.csv")
nonlinear_AJCC7N_3 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7N_3.csv")
nonlinear_AJCC7N_4 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7N_4.csv")
nonlinear_AJCC7N_5 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7N_5.csv")


nonlinear_AJCC7M_1 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7M_1.csv")
nonlinear_AJCC7M_2 <- read.csv("./revision-03-csd-crc/results/nonlinear_AJCC7M_2.csv")


nonlinear_Surgery_1 <- read.csv("./revision-03-csd-crc/results/nonlinear_Surgery_1.csv")
nonlinear_Surgery_2 <- read.csv("./revision-03-csd-crc/results/nonlinear_Surgery_2.csv")
nonlinear_Surgery_3 <- read.csv("./revision-03-csd-crc/results/nonlinear_Surgery_3.csv")
nonlinear_Surgery_4 <- read.csv("./revision-03-csd-crc/results/nonlinear_Surgery_4.csv")
nonlinear_Surgery_5 <- read.csv("./revision-03-csd-crc/results/nonlinear_Surgery_5.csv")
nonlinear_Surgery_6 <- read.csv("./revision-03-csd-crc/results/nonlinear_Surgery_6.csv")

nonlinear_radiation_1 <- read.csv("./revision-03-csd-crc/results/nonlinear_radiation_1.csv")
nonlinear_radiation_2 <- read.csv("./revision-03-csd-crc/results/nonlinear_radiation_2.csv")

# nonlinear_radiation <- read.csv("./revision-03-csd-crc/results/nonlinear_radiation.csv")
...
tiff(file = "./revision-03-csd-crc/results/non_age.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
ggplot(data = df_age, mapping = aes(x = Age, y = CIF, color = Time)) +
  # geom_line(size = 1) + 
  geom_line(size = 1.2, aes(color = Time, linetype = Time)) + 
  scale_y_continuous(limits = c(0, 50)) + 
  # scale_color_manual(values = c('HotPink','Blue', 'Green', 'Purple', 'DeepSkyBlue', 'Peru', 'Black', 'Red')) + #?Զ?????ɫ
...
tiff(file = "./revision-03-csd-crc/results/non_pln.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_race.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_site.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_hist.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_grade.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_Tstage.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_AJCC7N.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_AJCC7M.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_Surgery.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
...
tiff(file = "./revision-03-csd-crc/results/non_Radiation.tiff", res = 600, width = 4800, height = 3600, compression = "lzw")
